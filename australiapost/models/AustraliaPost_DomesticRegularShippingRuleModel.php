...
class AustraliaPost_DomesticRegularShippingRuleModel extends AustraliaPost_BaseShippingRuleModel implements ShippingRule
{
    ...
    {
        if (isset($this->_shippingOptions['postage_result']['delivery_time'])) {
            return $this->_shippingOptions['postage_result']['delivery_time'] . ' (includes insurance)';
        } else {
            return null;
        }
    }
